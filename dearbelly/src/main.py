...
JSON_PATH = HERE / "models" / 'matched_all.json'
...
@app.post("/scan/info")
def create_item(request: CreateScanInfoRequest):

    image_path = HERE / "img" / request.img_path
    pill_name = predict(image_path)

    return {"pill_name": pill_name}